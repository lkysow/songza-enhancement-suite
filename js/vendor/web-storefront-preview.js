...
function _itsdlogFunnel(e, t, n) {
    t || (t = "log");
    if (_itsdlogHasClientLogger(t))
        return its.client[t](e, n);
    if (_itsdlogHasConsoleLogger(t) && !n)
        return console[t](e)
}
function itsdlog(e) {
...
function classNameForObject(e) {
    ...
    if (t == "undefined")
        return "undefined";
    if (t == "string" || e instanceof String)
        return "String";
    ...
    if (t == "object" || t == "function") {
        ...
        if (n.indexOf("function ") === 0)
            return n.replace("function ", "").split("(")[0].toString();
        if (n.indexOf("[object ") === 0)
            return n.replace("[object ", "").replace("]", "");
        if (n.indexOf("[object]") === 0)
            return "object"
    }
    return "unknown"
...
function detectAndOpenItunes(e) {
    ...
    var r = its.detect.itunesDetected(), i = its.detect.shouldAutolaunch();
    return itms.PageData.itunesDetectedCallback(r, i), r && i ? its.detect.openItunes(e) : !0
}
function detectAndOpenMacAppStore(e) {
    var t = its.detect.macAppStoreDetected(), n = its.detect.shouldAutolaunch();
...
window.its || (window.its = {}), its.files || (its.files = {}), Function.prototype.bind || (Function.prototype.bind = function(e) {
    var t = this, n = Array.prototype.slice, r = n.call(arguments, 1);
    return function() {
        return t.apply(e, r.concat(n.call(arguments)))
    }
}), Class = {create: function(e, t) {
        return Class._create(e, t)
    },createSubclass: function(e, t, n) {
        if (!t)
            throw new Error("Undefined base class when creating subclass: " + e);
        ...
        function i(e, t, n) {
            var r = e[n];
            e[n] = function() {
                var i = t[n], s = this.base, o = arguments;
                this.base = function() {
        ...
        if (n)
            for (var o in n.prototype)
                r.prototype.hasOwnProperty(o) && typeof r.prototype[o] == "function" && typeof n.prototype[o] == "function" && i(r.prototype, n.prototype, o);
    ...
    n != null && r < n.length;
    r++)
        if (n[r].textContent == t && n[r].nextElementSibling != null && n[r].nextElementSibling.nodeName == "string")
            return n[r].nextElementSibling.textContent;
    return null
    ...
    n || (n = "log");
    if ((r || its.x && its.x.isIE && its.x.isIE()) && window.ITSOnScreenConsole)
        its.client.onscreenConsole().log(t, n);
    ...
    i++) {
        var s = e.childNodes[i];
        if (s.nodeType === Node.ELEMENT_NODE) {
            if (s.lastChild && s.lastChild.textContent == t)
                return r;
            r++
        }
    }
    ...
    if (typeof its.x.initBrowserDetect.browser == "undefined" || !its.x.initBrowserDetect.browser) {
        var t = navigator, n = t.userAgent, r = t.appVersion, i = parseFloat(r), s = {};
        ...
        if (o && !s.isChrome) {
            ...
            if (!s.isSafari || parseFloat(r.substr(o + 7)) <= 419.3)
                s.isSafari = 2
        }
...
}, its.x._ITSEventDispatcher = function() {
}, its.x._ITSEventDispatcher.itsAddEventListener = function(t, n) {
    var r = !1;
    ...
    if (!t)
        throw new Error("itsHasEventListeners called with null event");
    ...
    if (this.__additionalDispatchers.length > 0)
        for (var r = 0;
    ...
    if (its && its.property && its.property("DynaLoader.allowDynaLoading")) {
        ...
        if (t && !its.contains(its._dynaLoadedFiles, t)) {
            var i = null, s = null, o = null, i = document.getElementsByTagName("head");
            ...
            if (o) {
                ...
                window.console && console.log && (console.log("its.x.dynaLoadResourceFile: Waiting for DOM <head> section to be created before fetching resource: " + t), window.setTimeout(function() {
    ...
    var n = null, r = its.rootResourcesPathFromCssFilename(t);
    ...
    r < t.length;
    r++)
        its.x.element.removeClassName(t[r], n)
}, its.x.element._printAll = function() {
    for (var t in its.x.element) {
        var n = its.x.element[t], r = its.dev.parseFunctionArgsToArray(n), i = r.shift(), s = r.join(", ");
    ...
    var n = its.x.element.isOverflowing(t), r = "ellipsis", i = "532", s = its.webkitVersion();
    ...
    i++) {
        var s = t.attributes.item(i).nodeName;
    ...
    r < n.length;
    r++)
        if (!its.x.element.hasClassName(t, n[r]))
            return !1;
    return !0
    ...
    var r = its.x.element.classNamesStartingWith(t, n), i = r.length ? r[0] : null;
    return i
}, its.x.element.classNamesStartingWith = function(t, n) {
    var r = t.className.split(" "), i = [];
    for (var s = 0;
    s < r.length;
    s++)
        its.string.startsWith(r[s], n) && i.push(r[s]);
    return i
    ...
    if (r && r.length)
        ...
        i < r.length;
        i++)
            its.x.element.removeClassName(t, r[i])
    ...
    i < t.length;
    i++)
        (!r || t[i] != r) && its.x.element.removeClassName(t[i], n)
    ...
    var n = t, r = new Object;
    r.left = r.top = 0;
    if (n.offsetParent)
        do
            r.left += n.offsetLeft, r.top += n.offsetTop;
    ...
    var r = t, i = !0, s = null, o = null, u = null, a = null, f = its.x.element.logger(), l = !1, c = null;
    while (i && r) {
    ...
    var n = its.x.element.isVisible(t), r = its.x.element.logger();
    if (n) {
        var i = !1, s = t.getBoundingClientRect(), o = {top: s.top,bottom: s.bottom,left: s.left,right: s.right,width: s.width,height: s.height}, u = t.parentNode, a = parseInt(t.getAttribute("width"), 10), f = parseInt(t.getAttribute("height"), 10);
        a && (o.width = a, o.right = o.left + a), f && (o.height = f, o.bottom = o.top + f);
        while (n && u && !i && its.x.element.isVisible(u)) {
            var l = getComputedStyle(u);
            if (l && l.getPropertyValue("position") == "absolute")
                i = !0;
            else {
        ...
        if (n) {
            var p = {top: 0,bottom: window.innerHeight,left: 0,right: window.innerWidth};
        ...
        r.debug("isOnscreen: image.isVisible() = false");
    return n
    ...
    var r = t, i;
    do
        i = r.querySelectorAll(n), r = r.parentNode;
    ...
    var r = document.querySelectorAll(n), s = r.length;
    ...
    if (i && !acme.isChrome) {
        ...
        if (!acme.isSafari || parseFloat(n.substr(i + 7)) <= 419.3)
            acme.isSafari = 2
    }
    ...
    var t = e.trim, n = e.forEach, r = e._NodeListCtor = e.NodeList, i = function() {
        return e.doc
    }, s = (e.isWebKit || e.isMozilla) && i().compatMode == "BackCompat", o = i().firstChild.children ? "children" : "childNodes", u = ">~+", a = !1, f = function() {
        return !0
    }, l = function(e) {
        u.indexOf(e.slice(-1)) >= 0 ? e += " * " : e += " ";
        var n = function(n, r) {
            return t(e.slice(n, r))
        }, r = [], i = -1, s = -1, o = -1, f = -1, l = -1, c = -1, h = -1, p = "", d = "", v, m = 0, g = e.length, y = null, b = null, w = function() {
            if (h >= 0) {
                var e = h == m ? null : n(h, m);
                y[u.indexOf(e) < 0 ? "tag" : "oper"] = e, h = -1
            }
        }, E = function() {
            c >= 0 && (y.id = n(c, m).replace(/\\/g, ""), c = -1)
        }, S = function() {
            l >= 0 && (y.classes.push(n(l + 1, m).replace(/\\/g, "")), l = -1)
        }, x = function() {
            E(), w(), S()
        }, T = function() {
            x(), f >= 0 && y.pseudos.push({name: n(f + 1, m)}), y.loops = y.pseudos.length || y.attrs.length || y.classes.length, y.oquery = y.query = n(v, m), y.otag = y.tag = y.oper ? null : y.tag || "*", y.tag && (y.tag = y.tag.toUpperCase()), r.length && r[r.length - 1].oper && (y.infixOper = r.pop(), y.query = y.infixOper.query + " " + y.query), r.push(y), y = null
        };
        for (;
        ...
        m++) {
            if (p == "\\")
                continue;
            y || (v = m, y = {query: null,pseudos: [],attrs: [],classes: [],tag: null,oper: null,id: null,getTag: function() {
            ...
            if (i >= 0) {
                ...
                s >= 0 ? d == ")" && (f >= 0 && (b.value = n(s + 1, m)), f = s = -1) : d == "#" ? (x(), c = m + 1) : d == "." ? (x(), l = m) : d == ":" ? (x(), f = m) : d == "[" ? (x(), i = m, b = {}) : d == "(" ? (f >= 0 && (b = {name: n(f + 1, m),value: null}, y.pseudos.push(b)), s = m) : d == " " && p != d && T()
        }
        return r
    }, c = function(e, t) {
        return e ? t ? function() {
        ...
        }}, g = typeof i().firstChild.nextElementSibling == "undefined", y = g ? "nextSibling" : "nextElementSibling", b = g ? "previousSibling" : "previousElementSibling", w = g ? p : f, E = function(e) {
        while (e = e[b])
            if (w(e))
                return !1;
        return !0
        ...
        var t = e.parentNode, n = 0, r = t[o], i = e._i || -1, s = t._l || -1;
        if (!r)
            return -1;
        var u = r.length;
        if (s == u && i >= 0 && s >= 0)
        ...
        return x(e) % 2
            ...
            return function(e) {
                var t = e.childNodes, n = e.childNodes.length;
                for (var r = n - 1;
                r >= 0;
                r--) {
                    var i = t[r].nodeType;
            ...
            if (t == "even")
                return T;
            if (t.indexOf("n") != -1) {
                var r = t.split("n", 2), i = r[0] ? r[0] == "-" ? -1 : n(r[0]) : 1, s = r[1] ? n(r[1]) : 0, o = 0, u = -1;
        ...
        var t = e.toLowerCase();
        return t == "class" && (e = "className"), function(n) {
        ...
        return e = e || f, function(t, n, r) {
            var i, s = 0, u = t[o];
            while (i = u[s++])
                w(i) && (!r || Q(i, r)) && e(i, s) && n.push(i);
            return n
        }
    }, _ = function(e, t) {
        var n = e.parentNode;
        ...
        if (!o)
            if (t.id)
                u = !t.loops && l ? f : L(t, {el: 1,id: 1}), n = function(n, r) {
                ...
                u = L(t, {el: 1,classes: 1,id: 1});
                var p = t.classes.join(" ");
                n = function(e, t, n) {
                    var r = h(0, t), i, s = 0, o = e.getElementsByClassName(p);
                    while (i = o[s++])
                        u(i, e) && Q(i, n) && r.push(i);
                    return r
                }
            } else
                !l && !t.loops ? n = function(e, n, r) {
                    var i = h(0, n), s, o = 0, u = e.getElementsByTagName(t.getTag());
                    while (s = u[o++])
                        Q(s, r) && i.push(s);
                    return i
                } : (u = L(t, {el: 1,tag: 1,id: 1}), n = function(e, n, r) {
                    var i = h(0, n), s, o = 0, a = e.getElementsByTagName(t.getTag());
                    while (s = a[o++])
                        u(s, e) && Q(s, r) && i.push(s);
                    return i
                });
        else {
            var d = {el: 1};
        ...
        var n = h(e), r, i, s, o = t.length, u, a;
        for (var f = 0;
        f < o;
        f++) {
    ...
    }, I = navigator.userAgent, q = "WebKit/", R = e.isWebKit && I.indexOf(q) > 0 && parseFloat(I.split(q)[1]) > 528, U = e.isIE ? "commentStrip" : "nozip", z = "querySelectorAll", W = !!i()[z] && (!e.isSafari || e.isSafari > 3.1 || R), X = /n\+\d|([^ ])?([>~+])([^ =])?/g, V = function(e, t, n, r) {
        ...
        var n = K(e);
        return t[n] ? 0 : t[n] = 1
    }, G = "_zipIdx", Y = function(t) {
        if (t && t.nozip)
            return r._wrap ? r._wrap(t) : t;
        var n = new r;
        if (!t || !t.length)
            return n;
        t[0] && n.push(t[0]);
        ...
        if (e.isIE && a) {
            ...
            o = t[s];
            s++)
                t[s].getAttribute(G) != i && n.push(o), o.setAttribute(G, i)
        } else if (e.isIE && t.commentStrip)
            try {
                for (var s = 1, o;
                o = t[s];
                s++)
    ...
    e.query = function(t, n) {
        ...
        var r = new e._NodeListCtor, i = L(l(n)[0]);
        for (var s = 0, o;
        o = t[s];
        s++)
            i(o) && r.push(o);
    ...
    return e.indexOf("呩") == 0 && (e = "iTunes Pre 9.2 (Windows Version Unknown)"), e
    ...
    var n = {}, r = its.url.parseHostname(t), i = null, s = null;
    ...
    var e = "applesuperglobal", t = s_gi(e);
...
its.useragent.compareVersionStrings = function(t, n) {
    ...
    var s = new _ITSBindingInfo(t, n, r, i), o = s.hashKey();
    ...
    for (var t in _itsControllersToBind) {
        var n = _itsControllersToBind[t], r = its.x.querySelectorAll(document, n.selector);
...
its.x.notifyOfDOMContentLoaded(its._bindControllers), window.ITSMediaPlayer || (window.ITSMediaPlayer = {}), ITSMediaPlayer.events || (ITSMediaPlayer.events = {}), its.x.extendWithEventDispatching(ITSMediaPlayer), ITSMediaPlayer.events.PLAYBACK_STARTED = "playbackStarted", ITSMediaPlayer.events.PLAYBACK_PAUSED = "playbackPaused", ITSMediaPlayer.events.PLAYBACK_ENDED = "playbackEnded", ITSMediaPlayer.events.CAN_PLAY = "canPlay", ITSMediaPlayer._QUICK_TIME_PLAYER = "quick-time", ITSMediaPlayer._HTML5_AUDIO_PLAYER = "html5-audio", ITSMediaPlayer._ID = "media-player", ITSMediaPlayer._QUICK_TIME_VERSION_SUPPORTING_DOM_EVENTS = 721, ITSMediaPlayer._MIN_QUICK_TIME_VERSION_WIN_SETURL_BROKEN = 766, ITSMediaPlayer._MAX_QUICK_TIME_VERSION_WIN_SETURL_BROKEN = 768, ITSMediaPlayer._DEBUG = !1, ITSMediaPlayer._mediaPlayer = "undefined", ITSMediaPlayer._mediaPlayerTypeToUse = "undefined", ITSMediaPlayer._timers = new Array, ITSMediaPlayer._qtVersion = "undefined", its.x.isWindows() && its.x.isFirefox() ? ITSMediaPlayer._qtInitializationCompleteTimeoutMilliSeconds = 500 : ITSMediaPlayer._qtInitializationCompleteTimeoutMilliSeconds = 1e3, ITSMediaPlayer._qtInitializationPollingFrequencyMilliSeconds = 50, ITSMediaPlayer._clearTimers = function() {
    if (ITSMediaPlayer._timers) {
        ...
        t++)
            clearTimeout(ITSMediaPlayer._timers[t]);
    ...
    if (ITSMediaPlayer._played) {
        ITSMediaPlayer._stopPlayTime = (new Date).getTime(), ITSMediaPlayer._clearTimers();
        var t = ITSMediaPlayer._mediaPlayer;
        t && (ITSMediaPlayer.isQuickTimeBeingUsed() ? t.Stop() : ITSMediaPlayer.isHtml5AudioTagBeingUsed() && (ITSMediaPlayer._pausePlayTime = (new Date).getTime(), t.pause(), t.src = ""))
    }
}, ITSMediaPlayer._tryToPlay = function() {
    var t = ITSMediaPlayer._mediaPlayer, n = its.x.isWindows() && its.x.isFirefox();
    ...
    if (n) {
        ...
        if (ITSMediaPlayer.isQuickTimeBeingUsed()) {
            ...
            var r = n.GetVolume();
            n.SetVolume(0), ITSMediaPlayer._startPlayTime = (new Date).getTime(), n.Play(), r && (ITSMediaPlayer._DEBUG && console.log(n.GetVolume()), ITSMediaPlayer._timers.push(setTimeout(function() {
    ...
    ITSMediaPlayer.isHtml5AudioTagBeingUsed() && ITSMediaPlayer._DEBUG && console.log((new Date).getTime() - ITSMediaPlayer._startLoadTimeHtml5 + "ms Elapsed time between internal Html5load request and playbackStarted callback"), ITSMediaPlayer._DEBUG && console.log((new Date).getTime() - ITSMediaPlayer._startPlayTime + "ms Elapsed time between client play request and playbackStarted callback"), ITSMediaPlayer.itsDispatchEvent(new ITSEvent(ITSMediaPlayer.events.PLAYBACK_STARTED, ITSMediaPlayer))
    ...
    ITSMediaPlayer._DEBUG && console.log((new Date).getTime() - ITSMediaPlayer._pausePlayTime + "ms Elapsed time between client pause request and playbackPaused callback"), ITSMediaPlayer.itsDispatchEvent(new ITSEvent(ITSMediaPlayer.events.PLAYBACK_PAUSED, ITSMediaPlayer))
}, ITSMediaPlayer._internalPlaybackEndedCallback = function() {
    ITSMediaPlayer._DEBUG && console.log((new Date).getTime() - ITSMediaPlayer._stopPlayTime + "ms Elapsed time between client stop request and playbackEnded callback"), ITSMediaPlayer.itsDispatchEvent(new ITSEvent(ITSMediaPlayer.events.PLAYBACK_ENDED, ITSMediaPlayer))
    ...
    var r = !1, i = document.getElementById("media-player-container");
    ...
    if (ITSMediaPlayer._qtVersion === "undefined") {
        ...
        if (navigator.plugins && navigator.plugins.length)
            ...
            typeof execScript != "undefined" && (ieQTVersion = null, execScript('on error resume next: ieQTVersion = CreateObject("QuickTimeCheckObject.QuickTimeCheck.1").QuickTimeVersion', "VBScript"), ieQTVersion && (ITSMediaPlayer._qtVersion = (ieQTVersion >> 16).toString(16)))
    }
    ...
    var t = ITSMediaPlayer._detectPlugin.arguments, n = !1;
    if (navigator.plugins && navigator.plugins.length > 0) {
        ...
        pluginsArrayCounter++) {
            ...
            namesCounter++)
                (navigator.plugins[pluginsArrayCounter].name.indexOf(t[namesCounter]) >= 0 || navigator.plugins[pluginsArrayCounter].description.indexOf(t[namesCounter]) >= 0) && i++;
            if (i == t.length) {
                n = !0;
                break
            }
    ...
    n.__controller && n.__controller.setMouseState(ITSPlayMusicController.MOUSESTATE_DEFAULT)
}, ITSPlayMusicController.prototype = {togglePlayState: function(t) {
        ...
        if (this.playState != t) {
            this.playState = t;
            if (this.playState == ITSPlayMusicController.PLAYSTATE_STOPPED)
                ITSMediaPlayer.stop(), ITSMediaPlayer.itsRemoveEventListener(ITSMediaPlayer.events.CAN_PLAY, this._playbackStartedCallback), ITSMediaPlayer.itsRemoveEventListener(ITSMediaPlayer.events.PLAYBACK_ENDED, this._playbackEndedCallback), ITSPlayMusicController.__activeTrack == this && (ITSPlayMusicController.__activeTrack = null);
                ...
                this.playState != ITSPlayMusicController.PLAYSTATE_PLAYING && this.playState == ITSPlayMusicController.PLAYSTATE_PAUSED;
        ...
        if (this.playState == ITSPlayMusicController.PLAYSTATE_STOPPED)
            this.progressMeter && this.progressMeter.stop();
    ...
    }}, ITSPlayVideoController.prototype = {MAX_WIDTH: 416,init: function(e) {
        ...
        var e = parseInt(this.videoWrapper.getAttribute("video-width")), t = parseInt(this.videoWrapper.getAttribute("video-height")), n = e / t, r = this.videoWrapper.getAttribute("max-width") || this.MAX_WIDTH, i = Math.floor(r / n);
    ...
    jQuery.fn.AppGallery = function(e) {
        var t = {content: ".content",control: ".control",control_cap: ".control_cap",scroll: ".scroll",scroll_cap: ".scroll_cap",image_wrapper: "img"};
        e && jQuery.extend(t, e);
        var n, r, i = jQuery.browser.webkit, s = function(e, n) {
            this.willScroll = !1;
            var r = function(e) {
            ...
            if (this.container.width() < this.content.width) {
                var a = jQuery("div:first-child", this.container).get(0);
                if (u > 1) {
                    jQuery(a).css({width: this.content.width + "px"}).addClass("image-wrapper");
                    if (!i) {
                        r(this.container);
                        ...
                        jQuery(this.container).is_scrollable(f)
                    }
                } else
                    a.style.width = "auto"
            }
            ...
            this.get_view_width = function() {
                return n.width()
            }, this.images_meta = r(jQuery(t.image_wrapper, e)), this.images = this.images_meta.image_list, this.height = this.images_meta.tallest, this.width = this.images_meta.width, s(this.height), o(this.images, this.height), n && !i && jQuery(n.get(0)).css({"overflow-x": "hidden",padding: "0"})
        }, u = function(e) {
            var t = jQuery(e);
            this.get_dimensions = function() {
                return {width: t.outerWidth(!0),height: t.height()}
            }, this.get_height = function() {
                return jQuery("img", t).height()
    ...
    jQuery(".screenshots .content").AppGallery({content: "div:first",image_wrapper: ".lockup"})
}), function() {
    jQuery.fn.Pill = function(e) {
        var t = {toggleDiv: "div.screenshots div.content",toggleButtons: "div.screenshots div.pill a"};
        e && jQuery.extend(t, e);
        var n, r = function(e) {
            jQuery(e).each(function(e, n) {
                e < 1 && (jQuery(n).addClass("first active"), i(), jQuery(document.body).hasClass("social-preview") && twttr.remote.ui("resizeFrame", jQuery(document.body).height())), jQuery(n).click(function(e) {
                    e.preventDefault(), e.stopPropagation();
                    if (!jQuery(this).hasClass("active")) {
                        var n = jQuery(this);
                        jQuery(t.toggleDiv).each(function() {
                            jQuery(this).toggle()
                        }), jQuery(t.toggleButtons).each(function() {
            ...
            jQuery(t.toggleDiv).each(function(e, t) {
                e > 0 && jQuery(t).addClass("ipad")
            })
        };
        return n = new r(this), this
    }
}(), jQuery(window).load(function() {
    jQuery("body.software #main #content div.center-stack div.screenshots > div.title > div.pill > a").Pill()
}), function() {
    jQuery.fn.Hud = function(e) {
        var t = {table_row: "tr.podcast-episode",scroller: ".scroller",hide_hud: "#hide_hud",hud_close_link: "a.close_link",hud_content_wrapper: "div.content_wrapper",hud_content: "div.content",hud_title: "h2",hud_release_date_label: "span.release_date_label",hud_release_date_value: "span.release_date_value",hud_description: "p.description",left_offset: 321,top_offset: 12,fade_duration: 300};
        e && jQuery.extend(t, e);
        var n = this, r = null, i = null, s = !1, o = function(e) {
            jQuery(e).each(function(e, t) {
                var n = null;
                n = l(t), jQuery(t).click(function() {
                    u(this, n)
                })
            })
        }, u = function(e, r) {
            if (e != null && r != null) {
                ...
                n.hud ? jQuery(n.hud).css({top: parseInt(i.top - t.top_offset) + "px",left: parseInt(i.left - t.left_offset) + "px"}) : (jQuery("body").append('<div id="hide_hud"></div><div id="description_hud"><a class="close_link" href="#">Close</a><div class="scroller"><div class="track_well"><div class="track_well_cap"><div class="track_thumb"><div class="track_thumb_cap"></div></div></div></div></div><div class="content_wrapper"><div class="content"><h2></h2><p class="release_date"><span class="release_date_label"></span><span class="release_date_value"></span></p><p class="description"></p></div></div></div>'), n.hud = jQuery("#description_hud")[0], jQuery(n.hud).css({top: parseInt(i.top - t.top_offset) + "px",left: parseInt(i.left - t.left_offset) + "px"}), jQuery(n.hud).find(t.hud_close_link).click(function() {
                    return a(), !1
                }), jQuery(t.hide_hud).click(function() {
                    return a(), !1
                })), f(r)
            }
        }, a = function() {
            n.hud && (h(), its.x.isIE() ? (jQuery(n.hud).css({display: "none"}), jQuery(t.hide_hud).hide()) : jQuery(n.hud).fadeOut(t.fade_duration, function() {
                jQuery(t.hide_hud).hide()
            }))
        }, f = function(e) {
            if (n.hud && e) {
                var r = window["__desc_popup_d_" + e];
                r != null && (jQuery(n.hud).find(t.hud_title).html(r.title), jQuery(n.hud).find(t.hud_release_date_label).html(r.release_date_label), jQuery(n.hud).find(t.hud_release_date_value).html(r.release_date), jQuery(n.hud).find(t.hud_description).html(r.description)), its.x.isIE() ? (jQuery(n.hud).css({display: "block"}), its.x.isSafari() || c(), jQuery(t.hide_hud).show()) : jQuery(n.hud).fadeIn(t.fade_duration, function() {
                    its.x.isSafari() || c(), jQuery(t.hide_hud).show()
                })
            }
        }, l = function(e) {
            if (e)
                return jQuery(t.table_row).attr("adam-id")
        }, c = function() {
            this.scroll = jQuery(n.hud).find(t.hud_content).height() - jQuery(n.hud).find(t.hud_content_wrapper).height(), this.scroll > 0 && (jQuery(t.hud_content_wrapper).css({"overflow-y": "hidden"}), jQuery(t.scroller).css({left: "auto"}), jQuery(n.hud).is_scrollable({track_wrapper: t.scroller}))
        }, h = function() {
            this.scroll > 0 && (jQuery(t.scroller).css({left: "-9999px"}), jQuery(t.scroller + " .track_thumb").css({top: "0"}), jQuery(t.hud_content).css({top: "0"}))
        };
        return r = new o(this), this
    }
}(), jQuery(document).ready(function() {
    var e = {};
    jQuery("#main #content .track-list table tr").each(function(t, n) {
        e.table_row = n, jQuery(n).find("td span.episode-info").Hud(e)
    })
}), function() {
    jQuery.fn.is_scrollable = function(r) {
        var i = {orientation: "vertical",track_wrapper: ".track_wrapper",track_well: ".track_well",track_well_cap: ".track_well_cap",track_thumb: ".track_thumb",track_thumb_cap: ".track_thumb_cap",content_wrapper: ".content_wrapper",content: ".content",image_cap_size: 5};
        r && jQuery.extend(i, r);
        var s = new e(this, i), o = new t(this, i, s), u = new n(this, i, o);
        return this
    };
    var e = function(e, t) {
        var n = jQuery(t.content_wrapper, e), r = jQuery(t.content, n);
        ...
        var r = this, i = t.track_wrapper ? jQuery(t.track_wrapper, e) : null, s = t.track_well ? jQuery(t.track_well, i) : null, o = t.track_well_cap ? jQuery(t.track_well_cap, s) : null, u = t.track_thumb ? jQuery(t.track_thumb, s) : null, a = t.track_thumb_cap ? jQuery(t.track_thumb_cap, u) : null, f = 0;
        ...
        var c = function(e) {
            e > 100 && (e = 100), e < 0 && (e = 0), u.css({top: e + "%"})
        }, h = function() {
            return u.width()
        }, p = function() {
            ...
            e > 100 && (e = 100), e < -1.5 && (e = 0), u.css({width: e + "%"})
        }, m = function() {
            return parseFloat(u.css("height"))
        }, g = function(e) {
            e > 100 && (e = 100), e < -1.5 && (e = 0), u.css({height: e + "%"})
        }, y = function() {
            return i.offset().left
        }, b = function() {
            return i.offset().top
        }, w = function() {
            ...
            if (t["orientation"] == "vertical") {
                var e = t.image_cap_size, n = s.height() - e * 2;
                s.css({height: n + "px"}), o.css({top: e + "px"}), a.css({top: -1 * e + "px"})
            }
            f = x(t.orientation).min
        }, x = function(e) {
            var t, n;
        ...
        var r = !1, i = {x: 0,y: 0}, s = 0, o = Math, u = n.range, a = function(e) {
            return e.wheelDelta ? o.abs(e.wheelDeltaY / e.wheelDeltaX) <= .5 : e.axis == 1
        };
        jQuery(e).bind({content_select: function(e) {
                if (!r)
                    return;
                e.deselect()
            },mousewheel: function(e) {
                var t = n.get_scroll_position(), r = a(e.originalEvent);
                if (r) {
                    var i = e.detail ? e.detail * -120 : e.wheelDelta, s = e.detail ? o.round(3 * (i / -120)) : o.round(.3 * (i / -120));
                    if (s != 0) {
                        var f = t + s;
                        f > u.max && (f = u.max), f < u.min && (f = u.min), n.set_scroll(f)
                    }
                }
            }}), jQuery(n.track_wrapper).bind({click: function(e) {
    ...
    jQuery.event.special.content_select = {setup: function(e, t) {
            jQuery(this).data("content_selected", !1), jQuery(this).bind("mouseup", jQuery.event.special.content_select.handler), jQuery(this).bind("mousedown", jQuery.event.special.content_select.handler), jQuery(this).bind("mousemove", jQuery.event.special.content_select.handler), jQuery.event.special.content_select.scope = this
        },teardown: function(e) {
            jQuery(this).unbind("mouseup", jQuery.event.special.content_select.handler), jQuery(this).unbind("mousedown", jQuery.event.special.content_select.handler), jQuery(this).unbind("mousemove", jQuery.event.special.content_select.handler)
        },handler: function(e) {
            var t = jQuery.event.special.content_select.get_selected_text();
            t && (jQuery(this).data("content_selected", !0), e.type = "content_select", e.text = t, e.deselect = jQuery.event.special.content_select.deselect, jQuery.event.handle.apply(this, arguments))
        },deselect: function() {
            window.getSelection ? window.getSelection().removeAllRanges() : document.selection ? document.selection.empty() : document.getSelection && document.getSelection().removeAllRanges()
    ...
    $.event.special.mousewheel = {setup: function() {
        ...
        }}, $.fn.extend({mousewheel: function(e) {
            return e ? this.bind("mousewheel", e) : this.trigger("mousewheel")
        },unmousewheel: function(e) {
            return this.unbind("mousewheel", e)
        }});
    var i = function(e) {
        var t = [].slice.call(arguments, 1), n = 0, r = !0;
    ...
    jQuery.fn.Truncate = function(e) {
        ...
        var n, r = function(e) {
            jQuery(e).each(function(e, n) {
                var r = jQuery(n);
                if (jQuery(r).height() > t.maxHeight) {
                    var s = jQuery(r).parent("div.product-review"), o = jQuery(s).attr("more-text") || "More";
                    jQuery(r).addClass("truncate").css({height: t.maxHeight + "px"}), jQuery(r).parent("div.product-review").append('<a href="#" class="more-link">...' + o + "</a>"), i(jQuery(r).siblings("a.more-link"))
                }
            })
        }, i = function(e) {
            e && jQuery(e).click(function(e) {
                e.preventDefault(), jQuery(this).siblings(".truncate").each(function(e, t) {
                    jQuery(t).css({height: "auto"}), jQuery(t).removeClass("truncate")
                }), jQuery(this).remove()
            })
        };
        return n = new r(this), this
    ...
    var t = document.getElementById("iTunesDetectorIE"), n = !1;
    ...
    if (navigator.plugins && navigator.plugins.length > 0)
        ...
        n++) {
            var r = navigator.plugins[n], i = r.name;
    ...
    if (r) {
        ...
        if (t.indexOf("payPalMIPReturn") === -1 && t.indexOf("firstGateReturn") === -1 && t.indexOf("payclickSignUpReturn") === -1 && t.indexOf("payclickBillingReturn") === -1) {
            var s = t.indexOf("?") === -1 ? "?" : "&", o = its.cookies.get("a");
        ...
        t = itms.PageData.itunesDownloadUrl;
...
var deviceDetect = function() {
    ...
    switch (!0) {
        case -1 != e.indexOf("iPhone"):
            setViewport("iphone"), setTouchEvents(), jQuery("html").addClass("iphone"), jQuery("body").addClass("iphone");
            break;
        case -1 != e.indexOf("iPod"):
            setViewport("iphone"), setTouchEvents(), jQuery("html").addClass("iphone"), jQuery("body").addClass("iphone");
            break;
        case -1 != e.indexOf("iPad"):
            setViewport("ipad"), setTouchEvents(), jQuery("html").addClass("ipad"), jQuery("body").addClass("ipad");
            break;
        default:
            return
    }
    ...
    jQuery(document).ready(function() {
        jQuery("div.bottom-content a").each(function(e, t) {
    ...
    if (e) {
        ...
        jQuery("head").append(t), window.addEventListener("load", function() {
            setTimeout(function() {
                window.scrollTo(0, 1)
            }, 0)
        })
    ...
    return {replaceClass: function(e, t, n) {
            return n || (n = ""), dbg("Replacing " + t + " with " + n), e.className = e.className.replace(t, n), !1
        },PageData: {itunesDetectedCallback: function(e, t) {
                e ? (t ? document.getElementsByTagName("body")[0].className += " launching-itunes" : document.getElementsByTagName("body")[0].className += " no-action", setTimeout(function() {
                    ...
                    i < t.length;
                    i++)
                        t[i].className == "spinner" && (t[i].className = "no-spinner")
            ...
            },itunesDownloadUrl: "http://apple.com/itunes/download",itunesDetectorElement: document.getElementById("iTunesDetectorIE"),macAppStoreDetectedCallback: function(e, t) {
...
}(), Tracklist = {toHover: "div.track-list tbody tr",url: null,isSocial: null,init: function() {
        this.url = this.getURL(), this.isSocial = document.body.className.match(/song/);
        if (this.toHover)
            try {
        ...
        var e = "[\\?&]i=([^&#]*)", t = new RegExp(e), n = t.exec(window.location.href);
        if (n)
            return n[1]
...
Tracklist.domready(), function(e) {
    ...
    e.fn.willTruncate = function(n) {
        ...
        return this.each(function() {
            i = e(this), i.height() > r && (s = i.parent(), o = s.attr("more-text") || iTSLocalization ? iTSLocalization.localize("Js.TextTruncation.More") : "More", i.addClass("truncate").css({height: r + "px"}), s.append('<a href="#" class="more-link">...' + o + "</a>"), u = i.siblings("a.more-link"), u.click(function() {
                return jQuery(this).siblings(".truncate").removeClass("truncate").css({height: "auto"}), e(this).remove(), jQuery(document.body).hasClass("social-preview") && twttr.remote.ui("resizeFrame", jQuery(document.body).height()), !1
            }))
        })
    }
}(jQuery), jQuery(document).ready(function() {
    if (!!window.location.hash.match(/fullText/))
        return;
    ...
    e.fn.TVRating = function() {
        return this.each(function() {
            var e = jQuery(this), t = e.attr("rating-id"), n = e.attr("rating-system"), r = n + "-" + t;
            e.addClass(r)
        })
    }
}(jQuery), jQuery(document).ready(function() {
    jQuery.browser.msie && jQuery("span.content-rating").TVRating()
}), function(e) {
    ...
    jQuery.browser.msie && jQuery.browser.version < 8 && jQuery("a.artwork-link").LockupLink()
}), jQuery(document).ready(function() {
  return;
    init_nav()
}), function(e, t) {
    var n = 4, r = "Previous Tab", i = "Next Tab", s = /'s* celebrity playlist/i, o, u = [], a = {}, f, l = 0, c = 0;
    e.init_nav = function() {
        ...
        e++) {
            var n = o[e];
            e === 0 ? n.style.display = "block" : n.style.display = "none", u[e] = jQuery(".blurbs-title", n).get(0)
        }
        o.length > 1 && v()
    };
    var h = function() {
        ...
        jQuery("#left-stack .lockup .list li span.price").html(jQuery("div.price", e).html()), jQuery("#left-stack .lockup div.artwork img.artwork").get(0).src = jQuery("div.artwork img.artwork", e).get(0).src
    }, v = function() {
        ...
        w++) {
            if (u[w + e] === t)
                break;
            var E = o[w + e], S = document.createElement("a"), x = document.createElement("span");
            a[u[w + e].innerHTML.split(s).join("")] = {section: E,index: w + e}, S.className = "tab", S.style.zIndex = y, y -= 10, w === 0 && (S.className += " first"), w + c * n === l && (S.style.zIndex = 99999, S.className += " active", w < b - 1 && (S.className += " shadower")), S.href = "#", S.onclick = function(e) {
                var t = jQuery("span", this).get(0).innerHTML;
                return d(a[t].section), l = a[t].index, h(), a[t].section.style.display = "block", v(), e && e.returnValue && (e.returnValue = !1), !1
            }, x.innerHTML = u[w + e].innerHTML.split(s).join(""), S.appendChild(x), f[g].appendChild(S)
        }
        if (n !== u.length) {
            var T;
        ...
        jQuery(f[g]).eq(0).height() > jQuery(f[g].children[0]).outerHeight() && (n--, v())
    }
}(window)
